...
package com.appspot.ezrtt.emperapi;
...
public class Emperapi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *
   * @param content the {@link com.appspot.ezrtt.emperapi.model.Employee}
   * @return the request
   */
  public Addemployee addemployee(com.appspot.ezrtt.emperapi.model.Employee content) throws java.io.IOException {
    Addemployee result = new Addemployee(content);
    initialize(result);
    return result;
  }

  public class Addemployee extends EmperapiRequest<com.appspot.ezrtt.emperapi.model.Employee> {
     ...
     * @since 1.13
     */
    protected Addemployee(com.appspot.ezrtt.emperapi.model.Employee content) {
      super(Emperapi.this, "POST", REST_PATH, content, com.appspot.ezrtt.emperapi.model.Employee.class);
    }
  ...
  public class Getallemployees extends EmperapiRequest<com.appspot.ezrtt.emperapi.model.EmployeeCollection> {
    ...
    protected Getallemployees() {
      super(Emperapi.this, "GET", REST_PATH, null, com.appspot.ezrtt.emperapi.model.EmployeeCollection.class);
    }
  ...
  public class Getemperdetails extends EmperapiRequest<com.appspot.ezrtt.emperapi.model.Employer> {
    ...
    protected Getemperdetails() {
      super(Emperapi.this, "GET", REST_PATH, null, com.appspot.ezrtt.emperapi.model.Employer.class);
    }
  ...
  public class Getloggeduser extends EmperapiRequest<com.appspot.ezrtt.emperapi.model.Employer> {
   ...
   *
   * @param content the {@link com.appspot.ezrtt.emperapi.model.Employer}
   * @return the request
   */
  public Regemper regemper(com.appspot.ezrtt.emperapi.model.Employer content) throws java.io.IOException {
    Regemper result = new Regemper(content);
    initialize(result);
    return result;
  }

  public class Regemper extends EmperapiRequest<com.appspot.ezrtt.emperapi.model.Status> {
     ...
     * @since 1.13
     */
    protected Regemper(com.appspot.ezrtt.emperapi.model.Employer content) {
      super(Emperapi.this, "POST", REST_PATH, content, com.appspot.ezrtt.emperapi.model.Status.class);
    }
  ...
  public class Testapi extends EmperapiRequest<com.appspot.ezrtt.emperapi.model.Status> {
     ...
     */
    protected Testapi() {
      super(Emperapi.this, "GET", REST_PATH, null, com.appspot.ezrtt.emperapi.model.Status.class);
    }
  ...
  public class Viewreport extends EmperapiRequest<com.appspot.ezrtt.emperapi.model.EmpWeekInfoCollection> {
    ...
    protected Viewreport(java.lang.String emploeenum, java.lang.String date) {
      super(Emperapi.this, "POST", REST_PATH, null, com.appspot.ezrtt.emperapi.model.EmpWeekInfoCollection.class);
