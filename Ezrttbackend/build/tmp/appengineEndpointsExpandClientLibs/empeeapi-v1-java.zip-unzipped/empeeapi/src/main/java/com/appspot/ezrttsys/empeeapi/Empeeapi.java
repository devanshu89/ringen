...
public class Empeeapi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Getloc extends EmpeeapiRequest<com.appspot.ezrttsys.empeeapi.model.EmpWeekInfoCollection> {
    ...
    protected Getloc(java.lang.String employeenum, java.lang.String fromdate, java.lang.String todate) {
      super(Empeeapi.this, "GET", REST_PATH, null, com.appspot.ezrttsys.empeeapi.model.EmpWeekInfoCollection.class);
  ...
  public class Testdate extends EmpeeapiRequest<com.appspot.ezrttsys.empeeapi.model.Status> {
     ...
     */
    protected Testdate() {
      super(Empeeapi.this, "POST", REST_PATH, null, com.appspot.ezrttsys.empeeapi.model.Status.class);
    }
   ...
   *
   * @param content the {@link com.appspot.ezrttsys.empeeapi.model.EmpLoc}
   * @return the request
   */
  public Updateloc updateloc(com.appspot.ezrttsys.empeeapi.model.EmpLoc content) throws java.io.IOException {
    Updateloc result = new Updateloc(content);
    initialize(result);
    return result;
  }

  public class Updateloc extends EmpeeapiRequest<com.appspot.ezrttsys.empeeapi.model.EmpLoc> {
     ...
     * @since 1.13
     */
    protected Updateloc(com.appspot.ezrttsys.empeeapi.model.EmpLoc content) {
      super(Empeeapi.this, "PUT", REST_PATH, content, com.appspot.ezrttsys.empeeapi.model.EmpLoc.class);
    }
  ...
  public class Verifyempee extends EmpeeapiRequest<com.appspot.ezrttsys.empeeapi.model.Employee> {
    ...
    protected Verifyempee(java.lang.String emploeenum) {
      super(Empeeapi.this, "POST", REST_PATH, null, com.appspot.ezrttsys.empeeapi.model.Employee.class);
