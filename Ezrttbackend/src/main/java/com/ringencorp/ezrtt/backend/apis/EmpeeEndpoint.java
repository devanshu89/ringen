...
@Api(name = "empeeapi", version = "v1", clientIds = { Constants.WEB_CLIENT_ID, Constants.ANDROID_CLIENT_ID,
		Constants.IOS_CLIENT_ID, Constants.APIEXP_CLIENT_ID }, audiences = { Constants.ANDROID_AUDIENCE })
