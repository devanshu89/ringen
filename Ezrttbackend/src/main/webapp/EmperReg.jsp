			...
			<form onsubmit="return false;">
				...
				<div class="form-group">
					<input type="number" class="form-control" id="headcount"
						required="required" placeholder="Strength">
				</div>
				<div class="form-group">
					<select id="country" required="required">
						...
						<option value="408">Korea, Democratic People's Republic
							of</option>
						...
						<option value="654">Saint Helena, Ascension and Tristan
							da Cunha</option>
						...
						<option value="239">South Georgia and the South Sandwich
							Islands</option>
				...
				%>
				<input name="user" value="${user}" class="hidden">
				<div class="mbr-buttons mbr-buttons--right" id="addemper">
					<button type="submit"
						class="mbr-buttons__btn btn btn-lg btn-danger"
						onclick="google.appengine.samples.hello.addemper()">Submit</button>
				</div>
			</form>
		</div>
	</div>
